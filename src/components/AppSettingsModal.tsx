      ...
      >
        ...
        >
          ...
          <>
              ...
              {/* Annual Duration */}
              <div style={row}>
                <label style={labelStyle}>Annual Duration (months)</label>
                <select
              ...
              {/* Service Condition Preset */}
              <div style={row}>
                <label style={labelStyle}>
                  Service Condition Preset (Standard / Parts-Only)
                  {tooltip && (
                    <span style={{
                      marginLeft: 8, color: C.muted, fontSize: 10,
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  {["Minimum", "Medium", "Maximum"].map((p) => (
                    <button
                      ...
                      onMouseEnter={() => setTooltip(PRESET_TOOLTIPS[p])}
